...
PESREADER_DIR	= pesreader
PESREADER_SRC	=	$(PESREADER_DIR)/main.c	\
			$(PESREADER_DIR)/arg.c	\
...
all: $(UNSTUNTS_NAME) $(UNCOMP_NAME) $(COMP_NAME) $(STATS_NAME) $(MAKEGAME_NAME) $(PESREADER_NAME)
...
$(PESREADER_NAME): $(BIN_DIR) $(PESREADER_OBJ)
	$(CC) $(CFLAGS) -o $(BIN_DIR)/$(PESREADER_NAME) $(PESREADER_OBJ)
